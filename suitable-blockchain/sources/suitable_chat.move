module suitable_blockchain::suitable_chat {
    ...
    public entry fun create_chat(other_user: address, messages_init: address, ctx: &mut TxContext) {
    ...
    public entry fun get_last_messages(chat: &Chat, ctx: &TxContext): address {
    ...
    public fun send_message(chat: &mut Chat, walrus_url: address) {
